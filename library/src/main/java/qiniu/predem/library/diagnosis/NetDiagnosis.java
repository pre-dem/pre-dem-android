...
import static qiniu.predem.library.util.MatcherUtil.getIpFromTraceMatcher;
import static qiniu.predem.library.util.MatcherUtil.ipMatcher;
import static qiniu.predem.library.util.MatcherUtil.timeMatcher;
import static qiniu.predem.library.util.MatcherUtil.traceMatcher;
...
//            return null;
        ...
        try {
            ...
            //上报
            boolean res = sendRequest(HttpConfig.getDiagnosisUrl(),result.toJsonString());

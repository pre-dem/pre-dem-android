package qiniu.predem.library.exception;
...
public class CrashDetails {
    ...
    public void writeCrashReport() {
        String path = ConstantConfig.FILES_PATH + "/" + crashIdentifier + ".stacktrace";
    ...
    public static CrashDetails fromReader(String crashIdentifier, Reader in) throws IOException {
        ...
        while ((readLine = bufferedReader.readLine()) != null) {
            if (!headersProcessed) {
                ...
                if (colonIndex < 0) {
                    LogUtils.e(TAG,"Malformed header line when parsing crash details: \"" + readLine + "\"");
                }

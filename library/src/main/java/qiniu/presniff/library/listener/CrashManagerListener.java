package qiniu.presniff.library.listener;
...
public abstract class CrashManagerListener {
    ...
    /**
     * Called when the crash manager has sent crashes to CrashSDK.
     */
    public void onCrashesSent() {
    }

    /**
     * Called when the crash manager failed to send crashes to CrashSDK, e.g.
    ...
    /**
     * Called when the user denied to send crashes to CrashSDK.
     */
    public void onUserDeniedCrashes() {
    }

    /**
     * Get the number of max retry attempts to send crashes to CrashSDK.
